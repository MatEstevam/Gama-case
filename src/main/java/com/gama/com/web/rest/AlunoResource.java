...
import com.gama.com.service.AlunoService;
...
/**
 * REST controller for managing {@link com.gama.com.domain.Aluno}.
 */
@RestController
...
public class AlunoResource {
    ...
    public ResponseEntity<AlunoDTO> createAluno(@RequestBody AlunoDTO alunoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/alunos/" + alunoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, alunoDTO.getId().toString()))
            .body(alunoDTO);
    }
    ...
    public ResponseEntity<AlunoDTO> updateAluno(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, alunoDTO.getId().toString()))
            .body(alunoDTO);
    }
    ...
    public ResponseEntity<AlunoDTO> partialUpdateAluno(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, alunoDTO.getId().toString())
        );
    }
