...
import com.gama.com.repository.MetaRepository;
import com.gama.com.service.MetaService;
import com.gama.com.service.dto.MetaDTO;
import com.gama.com.service.mapper.MetaMapper;
...
class MetaResourceIT {
    ...
    private static final AreaDoEnem DEFAULT_AREA = AreaDoEnem.LINGUAGENS_CODIGOS_E_SUAS_TECNOLOGIAS;
    private static final AreaDoEnem UPDATED_AREA = AreaDoEnem.MATEMATICA_E_SUAS_TECNOLOGIAS;
    ...
    void partialUpdateMetaWithPatch() throws Exception {
        ...
        partialUpdatedMeta.area(UPDATED_AREA);
